...
public class AppMain extends Application {
    ...
    /** このアプリケーションのバージョン */
    public static final String VERSION = "v0.24.0";
    ...
    public static final double STAGE_HEIGHT_OPEN = 426d;
    
    /** 設定エリアを閉じたときのメインステージの最小高さ */
    public static final double STAGE_HEIGHT_CLOSE = 250d;
    ...
    private void announceNewFeature() {
        ...
        if (!VERSION.equals(prevVersion)) {
            ...
            assert VERSION.equals("v0.24.0");
            // v0.24.0 では次を行う。
            //  ・新機能紹介ページの表示
            
            try {
                Desktop.getDesktop().browse(URI.create("https://hogandiff.hotchpotch.xyz/releasenotes/v0-24-0/"));
            } catch (IOException e) {
                e.printStackTrace();
                // nop
            }

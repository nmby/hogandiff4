...
public class AppMain extends Application {
    ...
    /** このアプリケーションのバージョン */
    public static final String VERSION = "v0.21.0";
    ...
    private void announceNewFeature() {
        ...
        if (!VERSION.equals(prevVersion)) {
            ...
            assert VERSION.equals("v0.21.0");
            // v0.21.0 では新機能紹介ページを表示する。
            
            try {
                Desktop.getDesktop().browse(URI.create("https://hogandiff.hotchpotch.xyz/releasenotes/v0-21-0/"));
            } catch (IOException e) {
                e.printStackTrace();
                // nop
            }

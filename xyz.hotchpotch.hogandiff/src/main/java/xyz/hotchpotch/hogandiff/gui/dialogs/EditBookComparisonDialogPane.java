...
public class EditBookComparisonDialogPane extends EditComparisonDialogPane<PairingInfoBooks> {
     ...
     */
    public EditBookComparisonDialogPane(PairingInfoBooks bookComparison) throws IOException {
        super();
    ...
    /* package */ void init() throws IOException {
        try {
            ...
            ErrorReporter.reportIfEnabled(e, "EditBookComparisonDialogPane#init-1");
            throw e;
        }
    }
    ...
    public PairingInfoBooks getResult() {
        try {
            ...
            ErrorReporter.reportIfEnabled(e, "EditBookComparisonDialogPane#getResult-1");
            throw e;
        }
    }
    ...
    protected void unpair(int i) {
        try {
            ...
            ErrorReporter.reportIfEnabled(e, "EditBookComparisonDialogPane#unpair-1");
            throw e;
        }
    }
    ...
    protected void makePair(int src, int dst) {
        try {
            ...
            ErrorReporter.reportIfEnabled(e, "EditBookComparisonDialogPane#makePair-1");
            throw e;
        }
    }
}

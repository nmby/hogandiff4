...
public class BookInfoLoaderWithPoiEventApi implements BookInfoLoader {
    ...
    public static BookInfoLoader of(Set<SheetType> targetTypes) {
        ...
        return new BookInfoLoaderWithPoiEventApi(targetTypes);
    }
    ...
    private BookInfoLoaderWithPoiEventApi(Set<SheetType> targetTypes) {
        assert targetTypes != null;

...
/**
 * 縦方向の挿入／削除を考慮せずに縦方向の対応付けを行う {@link BiFunction} の実装です。<br>
 * 
 * @author nmby
 */
/* package */ class V0 implements BiFunction<Set<CellData>, Set<CellData>, List<IntPair>> {
    ...
    /* package */ V0(ToIntFunction<CellData> vertical) {

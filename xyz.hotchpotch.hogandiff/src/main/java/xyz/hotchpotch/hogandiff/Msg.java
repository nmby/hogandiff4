...
public enum Msg {
    ...
    MSG_033("excel.poi.usermodel.BookResultBookCreator.090"),
    ...
    MSG_070("excel.poi.usermodel.BookResultBookCreator.010"),
    ...
    MSG_087("gui.MainController.010"),

...
import xyz.hotchpotch.hogandiff.misc.excel.PasswordHandlingException;
...
public class SaxUtil {
    ...
    public static List<SheetInfo> loadSheetInfos(
        ...
        UnsafeFunction<ZipInputStream, List<SheetInfo>, Exception> processor = zis -> {
            ...
            // 糞がッッッ
            // see:
            // https://stackoverflow.com/questions/53690819/java-io-ioexception-stream-closed-zipinputstream

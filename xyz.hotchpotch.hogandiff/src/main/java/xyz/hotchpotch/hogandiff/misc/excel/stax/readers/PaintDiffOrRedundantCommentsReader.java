package xyz.hotchpotch.hogandiff.misc.excel.stax.readers;
...
import xyz.hotchpotch.hogandiff.misc.excel.CellsUtil;
import xyz.hotchpotch.hogandiff.misc.excel.stax.StaxUtil;
import xyz.hotchpotch.hogandiff.misc.excel.stax.StaxUtil.NONS_QNAME;
import xyz.hotchpotch.hogandiff.misc.excel.stax.StaxUtil.V_QNAME;
import xyz.hotchpotch.hogandiff.misc.excel.stax.StaxUtil.X_QNAME;
...
public class PaintDiffOrRedundantCommentsReader extends BufferingReader {
     ...
     *                                  {@code redundantCommentAddrs} がいずれも空の場合
     */

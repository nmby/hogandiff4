...
public class AppArgsParser {
    ...
    public static final String USAGE = ""
            ...
            + "    --prioritize-accuracy=[true|false]   : default value is "
            + SettingKeys.PRIORITIZE_ACCURACY.defaultValueSupplier().get() + BR
            + BR;
    ...
    private static final Map<String, Key<Boolean>> OPTIONS = Map.of(
            ...
            "--prioritize-accuracy", SettingKeys.PRIORITIZE_ACCURACY);

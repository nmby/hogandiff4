...
class SheetNamesLoaderWithPoiUserApiTest {
    ...
    static void beforeAll() throws URISyntaxException {
        test1_xls = BookOpenInfo.of(Path.of(me.getResource("Test1.xls").toURI()), null);
        test1_xlsb = BookOpenInfo.of(Path.of(me.getResource("Test1.xlsb").toURI()), null);
        test1_xlsm = BookOpenInfo.of(Path.of(me.getResource("Test1.xlsm").toURI()), null);
        test1_xlsx = BookOpenInfo.of(Path.of(me.getResource("Test1.xlsx").toURI()), null);
        test2_xls = BookOpenInfo.of(Path.of(me.getResource("Test2_passwordAAA.xls").toURI()), null);
        test2_xlsx = BookOpenInfo.of(Path.of(me.getResource("Test2_passwordAAA.xlsx").toURI()), null);
    ...
    void testLoadSheetNames_読み取りPW指定なしの場合() {
        ...
        // 開ける
        assertDoesNotThrow(
                () -> testee.loadSheetNames(BookOpenInfo.of(bookPwTest1_xls, null)));
        assertDoesNotThrow(
                () -> testee.loadSheetNames(BookOpenInfo.of(bookPwTest1_xlsx, null)));
        assertDoesNotThrow(
                () -> testee.loadSheetNames(BookOpenInfo.of(bookPwTest3_xlsx, null)));
        ...
        assertThrows(
                ...
                () -> testee.loadSheetNames(BookOpenInfo.of(bookPwTest3_xls, null)));
        
        // 開けずにPasswordHandlingExceptionをスロー
        assertThrows(
                PasswordHandlingException.class,
                () -> testee.loadSheetNames(BookOpenInfo.of(bookPwTest2_xls, null)));
        assertThrows(
                PasswordHandlingException.class,
                () -> testee.loadSheetNames(BookOpenInfo.of(bookPwTest2_xlsx, null)));
        assertThrows(
                PasswordHandlingException.class,
                () -> testee.loadSheetNames(BookOpenInfo.of(bookPwTest4_xls, null)));
        assertThrows(
                PasswordHandlingException.class,
                () -> testee.loadSheetNames(BookOpenInfo.of(bookPwTest4_xlsx, null)));
    }
    ...
    void testLoadSheetNames_読み取りPW指定ありの場合() {
        ...
        assertDoesNotThrow(
                () -> testee.loadSheetNames(BookOpenInfo.of(bookPwTest1_xls, "123")));
        assertDoesNotThrow(
                () -> testee.loadSheetNames(BookOpenInfo.of(bookPwTest1_xlsx, "123")));
        assertDoesNotThrow(
                () -> testee.loadSheetNames(BookOpenInfo.of(bookPwTest2_xls, "123")));
        assertDoesNotThrow(
                () -> testee.loadSheetNames(BookOpenInfo.of(bookPwTest2_xlsx, "123")));
        ...
        assertThrows(
                PasswordHandlingException.class,
                () -> testee.loadSheetNames(BookOpenInfo.of(bookPwTest3_xls, "123")));
        
        assertDoesNotThrow(
                () -> testee.loadSheetNames(BookOpenInfo.of(bookPwTest3_xlsx, "123")));
        ...
        assertThrows(
                PasswordHandlingException.class,
                () -> testee.loadSheetNames(BookOpenInfo.of(bookPwTest4_xls, "123")));
        
        assertDoesNotThrow(
                () -> testee.loadSheetNames(BookOpenInfo.of(bookPwTest4_xlsx, "123")));
    }
    ...
    void testLoadSheetNames_誤った読み取りPW指定ありの場合() {
        ...
        assertDoesNotThrow(
                () -> testee.loadSheetNames(BookOpenInfo.of(bookPwTest1_xls, "456")));
        assertDoesNotThrow(
                () -> testee.loadSheetNames(BookOpenInfo.of(bookPwTest1_xlsx, "456")));
        
        assertThrows(
                PasswordHandlingException.class,
                () -> testee.loadSheetNames(BookOpenInfo.of(bookPwTest2_xls, "456")));
        assertThrows(
                PasswordHandlingException.class,
                () -> testee.loadSheetNames(BookOpenInfo.of(bookPwTest2_xlsx, "456")));
        ...
        assertThrows(
                PasswordHandlingException.class,
                () -> testee.loadSheetNames(BookOpenInfo.of(bookPwTest3_xls, "456")));
        
        assertDoesNotThrow(
                () -> testee.loadSheetNames(BookOpenInfo.of(bookPwTest3_xlsx, "456")));
        
        assertThrows(
                PasswordHandlingException.class,
                () -> testee.loadSheetNames(BookOpenInfo.of(bookPwTest4_xls, "456")));
        assertThrows(
                PasswordHandlingException.class,
                () -> testee.loadSheetNames(BookOpenInfo.of(bookPwTest4_xlsx, "456")));
    }
}
